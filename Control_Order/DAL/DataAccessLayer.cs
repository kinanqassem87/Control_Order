...
namespace Control_Order.DAL
{
    class DataAccessLayer
    {
        //Server=Admin (Name of Computer) ; /Or Server=192.168.1.99;
        //public static string con = "Server= Admin; Database= Control_Order; Integrated Security=True;";
        public static string con = "Server= 192.168.1.99; Database= Control_Order;User ID=sa ;Password=123;Pooling=false;";
